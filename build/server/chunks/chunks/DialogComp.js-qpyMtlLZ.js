import { a8 as bind_props, ab as stringify$1, a7 as spread_props, a6 as escape_html } from './server.js-qDPizQqb.js';
import { h as getLocale } from './runtime.js-CbeSlHLA.js';
import { D as Dialog, a as Dialog_trigger, b as Dialog_content } from './dialog.js-CMONFBTM.js';
...
function DialogComp($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { title, label, eyebrow = dialogcomp_default_eyebrow(), children, variant = "default", class: className, contentClass = "", IconComp, open = false, hideTrigger = false } = $$props;
		let $$settled = true;
		let $$inner_renderer;
					...
					children: ($$renderer) => {
						...
						if (Dialog_content) {
							...
							Dialog_content($$renderer, {
								class: `bg-[#faf8f3] ${stringify$1(contentClass)}`,
								children: ($$renderer) => {
									children($$renderer);
									$$renderer.push(`<!---->`);
								},
...
//# sourceMappingURL=DialogComp.js-qpyMtlLZ.js.map
