...
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('../entries/hooks.server.js-Rly71VNp.js'));
	let reroute;
	let transport;
	({reroute, transport} = await import('../entries/hooks.universal.js-ApbkDnzm.js'));
	return {
		handle,
		handleFetch,
		handleError,
...
//# sourceMappingURL=internal2.js-CS4B5hQc.js.map
