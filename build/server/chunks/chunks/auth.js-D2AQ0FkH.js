...
import { c as count, d as desc, a as asc, i as inArray, n as notInArray, l as like, b as lt, e as lte, f as ne, g as gt, h as gte, j as eq, k as and, o as or, s as sql, m as db, p as subscribers } from './db.js-QS2RGzZQ.js';
import { c as createKyselyAdapter, s as sql$1 } from './dialect.js-DJNK594B.js';
import './routing.js-CU5UDpt8.js';
import './internal2.js-CeGHlmiW.js';
...
async function getBaseAdapter(options, handleDirectDatabase) {
	...
	if (!options.database) {
		...
		const { memoryAdapter } = await import('./memory-adapter.js-CNAtRaAi.js');
...
async function getAdapter(options) {
	return getBaseAdapter(options, async (opts) => {
		const { createKyselyAdapter } = await import('./kysely-adapter.js-Cx80IFW_.js');
		...
		const { kyselyAdapter } = await import('./kysely-adapter.js-Cx80IFW_.js');
...
//# sourceMappingURL=auth.js-D2AQ0FkH.js.map
