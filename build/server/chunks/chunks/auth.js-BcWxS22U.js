...
import { c as count, d as desc, a as asc, i as inArray, n as notInArray, l as like, b as lt, e as lte, f as ne, g as gt, h as gte, j as eq, k as and, o as or, s as sql, m as db, p as subscribers } from './db.js-BjhfTcAV.js';
...
import './internal2.js-CS4B5hQc.js';
...
async function getBaseAdapter(options, handleDirectDatabase) {
	...
	if (!options.database) {
		...
		const { memoryAdapter } = await import('./memory-adapter.js-BADbsGed.js');
...
async function getAdapter(options) {
	return getBaseAdapter(options, async (opts) => {
		const { createKyselyAdapter } = await import('./kysely-adapter.js-CSVhNrXZ.js');
		...
		const { kyselyAdapter } = await import('./kysely-adapter.js-CSVhNrXZ.js');
...
//# sourceMappingURL=auth.js-BcWxS22U.js.map
