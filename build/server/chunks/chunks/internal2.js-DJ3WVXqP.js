import { S as render, F as setContext, T as derived } from './server.js-qDPizQqb.js';
import { a as asClassComponent$1 } from './legacy-client.js-BfOaXL26.js';
...
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('../entries/hooks.server.js-ezdU2kDO.js'));
	let reroute;
	let transport;
	({reroute, transport} = await import('../entries/hooks.universal.js-TMOBtFD4.js'));
	return {
		handle,
		handleFetch,
		handleError,
...
//# sourceMappingURL=internal2.js-DJ3WVXqP.js.map
