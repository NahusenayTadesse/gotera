...
function DialogComp($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { title, label, eyebrow = dialogcomp_default_eyebrow(), children, variant = "default", class: className, contentClass = "", IconComp, open = false } = $$props;
		let $$settled = true;
		let $$inner_renderer;
...
//# sourceMappingURL=DialogComp.js-BpUg-w8q.js.map
