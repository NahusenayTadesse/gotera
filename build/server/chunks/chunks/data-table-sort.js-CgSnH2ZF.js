...
import { c as createSubscriber } from './scroll-lock.js-DHsXOzO5.js';
import { p as page } from './state.js-DU3l0yCp.js';
import { I as Icon } from './Icon.js-C-2f-rrd.js';
import { C as Chevron_down } from './chevron-down.js-ol8PFekw.js';
import { S as Scroll_area } from './scroll-area.js-BG2EJRIs.js';
import { w as createAttachmentKey, S as StyleToObject } from './create-id.js-ChicdcAh.js';
import { D as Dropdown_menu, a as Dropdown_menu_trigger, b as Dropdown_menu_content, g as Dropdown_menu_checkbox_item, c as Dropdown_menu_item } from './dropdown-menu.js-CI6WexMj.js';
...
import { i as isMobile } from './global.svelte.js-Cx8Mv6jx.js';
		...
		function $$render_inner($$renderer) {
			if (Resizable_pane_group) {
				...
				Resizable_pane_group($$renderer, {
					...
					class: `mt-4 flex gap-0 rounded-lg lg:w-fit lg:min-w-2xl ${stringify$1(className)}`,
					children: ($$renderer) => {
						if (Pane) {
							$$renderer.push("<!--[-->");
							Pane($$renderer, {
										...
										children: ($$renderer) => {
											...
											if (search) {
												...
												Scroll_area($$renderer, {
													...
													children: ($$renderer) => {
														$$renderer.push(`<div class="flex max-w-4xl flex-row items-start justify-start gap-2 p-4">`);
														Input($$renderer, {
															type: "search",
...
//# sourceMappingURL=data-table-sort.js-CgSnH2ZF.js.map
