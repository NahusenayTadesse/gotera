import { a4 as ensure_array_like, a6 as escape_html, ac as attr_style, ab as stringify$1 } from './server.js-qDPizQqb.js';
...
function DateRangeFilter($$renderer, $$props) {
	...
	$$renderer.push(`<!----> <select id="preset" name="preset" class="border-input h-9 rounded-md border bg-transparent px-3 text-base capitalize md:text-sm"><!--[-->`);
...
//# sourceMappingURL=chartPalette.js-Dur3IEhH.js.map
