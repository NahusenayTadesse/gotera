import { a9 as escape_html, $ as attr, ae as store_get, af as unsubscribe_stores, T as derived } from './server.js-CPNQ0GBv.js';
import { I as InputComp } from './InputComp.js-BpeR8FfL.js';
import { E as Errors } from './Errors.js-PqimIvij.js';
import { M as Mail } from './mail.js-MBTR6Dng.js';
import { b as Send } from './select-cell.js-Cqrto4vG.js';
import { D as DialogComp } from './DialogComp.js-D2AT0jNW.js';
import { B as Button } from './button.js-DMlVoc1I.js';
import { L as LoadingBtn } from './LoadingBtn.js-CvQQ0uH0.js';
import { b as superForm } from './client2.js-DmssoQeq.js';
import { a as zodClient } from './adapters.js-CmiyuZ8g.js';
import { b as bulkEmailSchema } from './bulkEmail.js-B9mPQG3L.js';

//#region src/lib/components/dashboard/BulkEmailDialog.svelte
function BulkEmailDialog($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		var $$store_subs;
		let { bulkEmailForm, rows, action = "?/sendBulkEmail" } = $$props;
		let open = false;
...
//# sourceMappingURL=BulkEmailDialog.js-CUd1HoGM.js.map
