...
import { s as sendMagicLink, a as sendChangeEmail, b as sendVerifyEmail, c as sendResetPassword } from './email.js-BnPglp6p.js';
import { c as count, d as desc, a as asc, i as inArray, n as notInArray, l as like, b as lt, e as lte, f as ne, g as gt, h as gte, j as eq, k as and, o as or, s as sql, m as db, p as subscribers } from './db.js-BXYNtFGm.js';
import { c as createKyselyAdapter, s as sql$1 } from './dialect.js-DJNK594B.js';
import './routing.js-CJYUshuD.js';
import './internal2.js-DJ3WVXqP.js';
...
async function getBaseAdapter(options, handleDirectDatabase) {
	...
	if (!options.database) {
		...
		const { memoryAdapter } = await import('./memory-adapter.js-CzDIQDM8.js');
...
async function getAdapter(options) {
	return getBaseAdapter(options, async (opts) => {
		const { createKyselyAdapter } = await import('./kysely-adapter.js-Ql6SmzWc.js');
		...
		const { kyselyAdapter } = await import('./kysely-adapter.js-Ql6SmzWc.js');
...
export { APIError as A, auth as a, createFetch as b, createAdapterFactory as c, defu as d, svelteKitHandler as s };
//# sourceMappingURL=auth.js-ngFc_BkE.js.map
