import { a0 as head, $ as attr, a6 as escape_html, aa as attr_class, a4 as ensure_array_like, ac as attr_style, ab as stringify$1, a3 as clsx$1, T as derived } from '../../chunks/server.js-qDPizQqb.js';
import { h as getLocale } from '../../chunks/runtime.js-CbeSlHLA.js';
import { A as Arrow_right } from '../../chunks/arrow-right.js-Dro87ZaY.js';
import { T as Testimonial } from '../../chunks/gallery.js-DmnXKVGK.js';
...
//#endregion
//#region src/lib/paraglide/messages/home_plan_freq_one_time.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Home_Plan_Freq_One_TimeInputs */
var en_home_plan_freq_one_time = () => {
	return `One-time order`;
};
var am_home_plan_freq_one_time = () => {
	return `የአንድ ጊዜ ትዕዛዝ`;
};
/**
* | output |
...
* | "One-time order" |
*
* @param {Home_Plan_Freq_One_TimeInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var home_plan_freq_one_time = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_home_plan_freq_one_time();
	return en_home_plan_freq_one_time();
});
//#endregion
	...
	$$renderer.component(($$renderer) => {
		...
		const cards = derived(() => (data?.subscriptionPlans ?? []).map((p) => {
			...
			return {
				...
				freq: oneOff ? home_plan_freq_one_time() : copy.freq ?? p.freq,
...
//# sourceMappingURL=_page.svelte.js-CL1NQrIO.js.map
