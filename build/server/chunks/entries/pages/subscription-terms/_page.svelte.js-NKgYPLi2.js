import { a0 as head, a9 as escape_html, a1 as html, a4 as ensure_array_like, aa as attr_class, $ as attr } from '../../../chunks/server.js-CPNQ0GBv.js';
import { h as getLocale } from '../../../chunks/runtime.js-CbeSlHLA.js';
import '../../../chunks/shared.js-CgqsOrws.js';

//#region src/lib/paraglide/messages/subterms_meta_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subterms_Meta_TitleInputs */
var en_subterms_meta_title = () => {
	return `Subscription Terms — GOTERA`;
};
var am_subterms_meta_title = () => {
	return `የምዝገባ ውሎች — GOTERA`;
};
/**
* | output |
* | --- |
* | "Subscription Terms — GOTERA" |
*
* @param {Subterms_Meta_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subterms_meta_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subterms_meta_title();
	return en_subterms_meta_title();
});
//#endregion
//#region src/lib/paraglide/messages/subterms_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subterms_Meta_DescriptionInputs */
var en_subterms_meta_description = () => {
	return `The terms that apply to GOTERA injera subscriptions, including billing, cancellation, pausing, and delivery.`;
};
var am_subterms_meta_description = () => {
	return `ለGOTERA እንጀራ ምዝገባዎች የሚተገበሩ ውሎች፣ ክፍያ፣ መሰረዝ፣ ማቆም እና መላኪያን ጨምሮ።`;
};
/**
* | output |
* | --- |
* | "The terms that apply to GOTERA injera subscriptions, including billing, cancellation, pausing, and delivery." |
*
* @param {Subterms_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subterms_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subterms_meta_description();
	return en_subterms_meta_description();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { data } = $$props;
		head("14qjqs", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(subterms_meta_title())}</title>`);
			});
			$$renderer.push(`<meta name="description"${attr("content", subterms_meta_description())}/>`);
		});
...
//# sourceMappingURL=_page.svelte.js-NKgYPLi2.js.map
