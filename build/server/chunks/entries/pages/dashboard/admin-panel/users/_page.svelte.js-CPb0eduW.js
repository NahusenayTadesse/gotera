import { a0 as head, ai as await_block, a6 as escape_html, $ as attr, ab as stringify$1, aa as attr_class, a3 as clsx$1, a7 as spread_props } from '../../../../../chunks/server.js-qDPizQqb.js';
...
import { E as Ellipsis } from '../../../../../chunks/ellipsis.js-Dns71XaR.js';
import { P as Plus } from '../../../../../chunks/plus.js-l9nzajpf.js';
import { D as Dropdown_menu, a as Dropdown_menu_trigger, b as Dropdown_menu_content, d as Dropdown_menu_group, e as Dropdown_menu_label, f as Dropdown_menu_separator, c as Dropdown_menu_item } from '../../../../../chunks/dropdown-menu.js-YJUTIf1N.js';
import { B as Button } from '../../../../../chunks/button.js-DWWbYMWk.js';
import { f as formatEthiopianDate, d as dropdownClass } from '../../../../../chunks/global.svelte.js-Bt1gRs1g.js';
	...
	$$renderer.component(($$renderer) => {
		...
		await_block($$renderer, data, () => {
			...
			if (data.userList.length === 0) {
				...
				$$renderer.push("<!--[-1-->");
				$$renderer.push(`<h2 class="my-4 text-xl sm:text-2xl">No of Users: ${escape_html(data.userList?.length)}</h2> <div class="mt-2 mb-4 w-full min-w-0 max-w-full p-0 sm:mt-8 sm:pt-4">`);
				Data_table($$renderer, {
					data: data.userList,
					columns,
					fileName: "Users List"
...
//# sourceMappingURL=_page.svelte.js-CPb0eduW.js.map
