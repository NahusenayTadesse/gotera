import { a0 as head, a8 as bind_props, F as setContext, T as derived, a2 as attributes, a3 as clsx$1, ab as stringify$1, a7 as spread_props, aa as attr_class, $ as attr, a6 as escape_html, a4 as ensure_array_like, J as getContext, a9 as props_id } from '../../../chunks/server.js-qDPizQqb.js';
import { o as on } from '../../../chunks/legacy-client.js-BfOaXL26.js';
import { s as setMode, r as resetMode } from '../../../chunks/dist.js-CopWy1Ce.js';
import { C as Context, o as DOMContext, P as Portal, n as noop, q as PresenceManager, w as watch, r as afterTick } from '../../../chunks/scroll-lock.js-DUdP1Ngb.js';
...
import { C as Chart_area } from '../../../chunks/chart-area.js-CHQrzPbW.js';
import { C as Chevron_right } from '../../../chunks/chevron-right.js-Bu3_elXi.js';
import { G as Gift, U as User_x } from '../../../chunks/user-x.js-C4EIEy9g.js';
import { S as Scroll_area } from '../../../chunks/scroll-area.js-DExXIpxT.js';
import { L as Log_out } from '../../../chunks/log-out.js-BtHwlbSa.js';
import { M as Mail } from '../../../chunks/mail.js-QCnsJSf5.js';
import { P as Package } from '../../../chunks/package.js-CN_Qv6ND.js';
import { R as Refresh_cw } from '../../../chunks/refresh-cw.js-BQ0xAi4S.js';
import { S as Search, C as Command, a as Command_input, b as Command_list, c as Command_empty, d as Command_group, e as Command_item } from '../../../chunks/command.js-WxuuArWj.js';
import { S as Sheet$1 } from '../../../chunks/sheet.js-8NUjIyFf.js';
import { T as Truck } from '../../../chunks/truck.js-CAOAaqne.js';
import { U as Users } from '../../../chunks/users.js-CmaohYfx.js';
import { D as Dialog, a as Dialog_trigger, b as Dialog_content, c as Dialog_header, d as Dialog$1, e as Dialog_content$1, f as Dialog_close, X, g as Dialog_overlay$1, h as Dialog_title, i as Dialog_title$1, j as DialogDescriptionState } from '../../../chunks/dialog.js-CMONFBTM.js';
import { c as createBitsAttrs, v as createId, b as boxWith, a as attachRef, n as mergeProps, d as boolToEmptyStrOrUndef, g as getDataOpenClosed, e as boolToStr, f as getDataTransitionAttrs } from '../../../chunks/create-id.js-BHb4azHX.js';
import { T as Tooltip_provider, a as Tooltip, b as Tooltip_trigger, c as Tooltip_content } from '../../../chunks/tooltip.js-CDsBDgDD.js';
import { D as Dropdown_menu, a as Dropdown_menu_trigger, b as Dropdown_menu_content, c as Dropdown_menu_item, d as Dropdown_menu_group, e as Dropdown_menu_label, f as Dropdown_menu_separator } from '../../../chunks/dropdown-menu.js-YJUTIf1N.js';
import { c as cn } from '../../../chunks/utils2.js-BmcH287A.js';
import { t as tv, b as buttonVariants, B as Button } from '../../../chunks/button.js-DWWbYMWk.js';
import '../../../chunks/shared.js-CgqsOrws.js';
import { I as IsMobile } from '../../../chunks/is-mobile.svelte.js-C7rjivRg.js';
import { b as bgGradient } from '../../../chunks/global.svelte.js-Bt1gRs1g.js';
...
//#region node_modules/@lucide/svelte/dist/icons/container.svelte
...
//#endregion
//#region node_modules/@lucide/svelte/dist/icons/cooking-pot.svelte
function Cooking_pot($$renderer, $$props) {
	let { $$slots, $$events, ...props } = $$props;
	Icon($$renderer, spread_props([
		{ name: "cooking-pot" },
		props,
...
//#endregion
//#region src/lib/components/dashboard/StockIndicator.svelte
function StockIndicator($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { stock } = $$props;
		if (stock) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<a href="/dashboard/stock"${attr_class("stock-pill svelte-16zo2sy", void 0, { "low": stock.low })}${attr("title", `${stringify$1(stock.remaining)} of ${stringify$1(stock.capacity)} left for ${stringify$1(stock.dateLabel)}`)}>`);
			Package($$renderer, { class: "h-4 w-4" });
			$$renderer.push(`<!----> <span class="stock-count svelte-16zo2sy">${escape_html(stock.remaining)}</span> <span class="stock-cap svelte-16zo2sy">/ ${escape_html(stock.capacity)}</span></a>`);
		} else $$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]-->`);
	});
}
//#endregion
//#region src/lib/components/bottomMenu.svelte
function BottomMenu($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		/**
		...
		*/
		...
		$$renderer.push(`<nav aria-label="Dashboard sections" class="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background lg:hidden" style="padding-bottom: env(safe-area-inset-bottom);"><ul class="grid grid-cols-5"><!--[-->`);
		const each_array = ensure_array_like(mobNav);
		for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
			let item = each_array[$$index];
			const active = isActive(item.url);
			const count = item.counter?.();
			$$renderer.push(`<li class="min-w-0"><a${attr("href", item.url)}${attr("aria-current", active ? "page" : void 0)}${attr_class(`relative flex min-h-14 flex-col items-center justify-center gap-1 px-1 py-2 transition-colors duration-200 active:bg-muted/60 ${active ? "text-primary" : "text-muted-foreground"}`)}><span class="relative flex size-6 items-center justify-center">`);
			if (item.icon) {
				$$renderer.push("<!--[-->");
			...
			if (count) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<span class="absolute -top-1.5 -right-2 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[10px] font-bold text-primary-foreground">${escape_html(formatCount(count))}</span>`);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--></span> <span class="w-full truncate text-center text-[11px] leading-none font-medium">${escape_html(item.title)}</span> `);
			if (active) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<span class="absolute inset-x-3 top-0 h-0.5 rounded-full bg-primary"></span>`);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--></a></li>`);
		}
		...
		if (Sidebar_provider) {
			...
			Sidebar_provider($$renderer, {
				children: ($$renderer) => {
					...
					$$renderer.push(`<!----> <main class="min-w-0 flex-1 px-4"><div class="sticky top-3 z-10 flex w-full flex-row justify-between rounded-lg border border-border bg-background p-3 pr-5 align-middle lg:bg-background/90 lg:pr-4 lg:backdrop-blur-md">`);
					if (Sidebar_trigger) {
						$$renderer.push("<!--[-->");
					...
					StockIndicator($$renderer, { stock: data?.stock });
					$$renderer.push(`<!----> `);
					Search_1($$renderer);
					$$renderer.push(`<!----> `);
					DarkMode($$renderer);
					...
					$$renderer.push(`<!----></div></div> <div class="p-4 pt-6 pb-24 lg:pt-8 lg:pb-8">`);
					children?.($$renderer);
...
//# sourceMappingURL=_layout.svelte.js-CjhgS3Mh.js.map
