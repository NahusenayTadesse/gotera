import { a0 as head, a6 as escape_html, aa as attr_class, ab as stringify$1, a4 as ensure_array_like, $ as attr, a1 as html, T as derived } from '../../../chunks/server.js-qDPizQqb.js';
...
//#endregion
//#region src/lib/paraglide/messages/account_tab_overview.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Account_Tab_OverviewInputs */
var en_account_tab_overview = () => {
	return `Overview`;
};
var am_account_tab_overview = () => {
	return `አጠቃላይ`;
};
/**
* | output |
...
* | "Overview" |
*
* @param {Account_Tab_OverviewInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var account_tab_overview = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_account_tab_overview();
	return en_account_tab_overview();
});
//#endregion
//#region src/lib/paraglide/messages/account_tab_delivery.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Account_Tab_DeliveryInputs */
var en_account_tab_delivery = () => {
	return `Delivery`;
};
var am_account_tab_delivery = () => {
	return `ማድረሻ`;
};
/**
* | output |
...
* | "Delivery" |
*
* @param {Account_Tab_DeliveryInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var account_tab_delivery = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_account_tab_delivery();
	return en_account_tab_delivery();
});
//#endregion
//#region src/lib/paraglide/messages/account_tab_history.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Account_Tab_HistoryInputs */
var en_account_tab_history = () => {
	return `History`;
};
var am_account_tab_history = () => {
	return `ታሪክ`;
};
/**
* | output |
...
* | "History" |
*
* @param {Account_Tab_HistoryInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var account_tab_history = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_account_tab_history();
	return en_account_tab_history();
});
//#endregion
//#region src/lib/paraglide/messages/account_tab_details.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Account_Tab_DetailsInputs */
var en_account_tab_details = () => {
	return `Details`;
};
var am_account_tab_details = () => {
	return `መረጃ`;
};
/**
* | output |
...
* | "Details" |
*
* @param {Account_Tab_DetailsInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var account_tab_details = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_account_tab_details();
	return en_account_tab_details();
});
//#endregion
//#region src/lib/paraglide/messages/account_tab_plan.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Account_Tab_PlanInputs */
var en_account_tab_plan = () => {
	return `Plan`;
};
var am_account_tab_plan = () => {
	return `ዕቅድ`;
};
/**
* | output |
...
* | "Plan" |
*
* @param {Account_Tab_PlanInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var account_tab_plan = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_account_tab_plan();
	return en_account_tab_plan();
});
//#endregion
//#region src/lib/paraglide/messages/account_tabs_aria.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Account_Tabs_AriaInputs */
var en_account_tabs_aria = () => {
	return `Account sections`;
};
var am_account_tabs_aria = () => {
	return `የመለያ ክፍሎች`;
};
/**
* | output |
...
* | "Account sections" |
*
* @param {Account_Tabs_AriaInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var account_tabs_aria = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_account_tabs_aria();
	return en_account_tabs_aria();
});
//#endregion
...
//#endregion
//#region src/lib/components/AccountSettings.svelte
function AccountSettings($$renderer) {
	$$renderer.push(`<div class="settings svelte-1bseihq">`);
	NotificationToggle($$renderer);
	$$renderer.push(`<!----> `);
	InstallAppRow($$renderer);
	$$renderer.push(`<!----></div> <div class="logout svelte-1bseihq">`);
	Logout($$renderer);
	$$renderer.push(`<!----></div>`);
}
//#endregion
//#region src/lib/components/AccountTabBar.svelte
function AccountTabBar($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		/**
		...
		*/
		let { links, isActive } = $$props;
		$$renderer.push(`<nav class="account-tabbar svelte-19o5vs7"${attr("aria-label", account_tabs_aria())}><!--[-->`);
		const each_array = ensure_array_like(links);
		for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
			let link = each_array[$$index];
			const active = isActive(link.href);
			$$renderer.push(`<a${attr("href", link.href)}${attr_class("tab svelte-19o5vs7", void 0, { "active": active })}${attr("aria-current", active ? "page" : void 0)}><svg class="tab-icon svelte-19o5vs7" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">${html(link.iconPath)}</svg> <span class="tab-label svelte-19o5vs7">${escape_html(link.short)}</span></a>`);
		}
		$$renderer.push(`<!--]--></nav>`);
	});
}
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		head("1bm518h", $$renderer, ($$renderer) => {
		...
		if (data.summary) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<div${attr_class(`status-pill status-${stringify$1(data.summary.status)}`, "svelte-1bm518h")}><span class="status-dot svelte-1bm518h"></span>${escape_html(data.summary.statusLabel)}</div>`);
		} else $$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></div></div></div> <div class="container svelte-1bm518h"><div class="layout svelte-1bm518h"><aside class="sidebar svelte-1bm518h"><div class="sidebar-section svelte-1bm518h"><span class="sidebar-label svelte-1bm518h">${escape_html(account_sidebar_manage_label())}</span> <nav class="sidebar-nav svelte-1bm518h"><!--[-->`);
		const each_array = ensure_array_like(managementLinks());
		for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
			let link = each_array[$$index];
			$$renderer.push(`<a${attr("href", link.href)}${attr_class("sidebar-link svelte-1bm518h", void 0, { "active": isActive(link.href) })}><svg class="sidebar-icon svelte-1bm518h" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">${html(link.iconPath)}</svg> ${escape_html(link.label)}</a>`);
		}
		...
		if (isActive("/account/details")) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<div class="mobile-settings svelte-1bm518h">`);
			AccountSettings($$renderer);
			$$renderer.push(`<!----></div>`);
		} else $$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></main></div></div> `);
		AccountTabBar($$renderer, {
			links: [...managementLinks(), ...subscriptionLinks()],
			isActive
		});
		$$renderer.push(`<!---->`);
	});
...
//# sourceMappingURL=_layout.svelte.js-ANzp9tJr.js.map
