import { a0 as head, a6 as escape_html, a4 as ensure_array_like, aa as attr_class, ab as stringify$1, $ as attr } from '../../../../chunks/server.js-qDPizQqb.js';
...
//#endregion
//#region src/lib/paraglide/messages/accthistory_page_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Accthistory_Page_TitleInputs */
var en_accthistory_page_title = () => {
	return `Order history — GOTERA`;
};
var am_accthistory_page_title = () => {
	return `የትዕዛዝ ታሪክ — ጎቴራ`;
};
/**
* | output |
* | --- |
* | "Order history — GOTERA" |
*
* @param {Accthistory_Page_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var accthistory_page_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_accthistory_page_title();
	return en_accthistory_page_title();
});
//#endregion
//#region src/lib/paraglide/messages/accthistory_load_more.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Accthistory_Load_MoreInputs */
var en_accthistory_load_more = () => {
	return `Load more`;
};
var am_accthistory_load_more = () => {
	return `ተጨማሪ ጫን`;
};
/**
* | output |
...
* | "Load more" |
*
* @param {Accthistory_Load_MoreInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var accthistory_load_more = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_accthistory_load_more();
	return en_accthistory_load_more();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { data } = $$props;
		head("four5f", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(accthistory_page_title())}</title>`);
			});
		});
		...
		if (data.orders.length === 0) {
			...
			if (data.hasMore) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<a class="load-more svelte-four5f"${attr("href", `?limit=${stringify$1(data.limit + 50)}`)} data-sveltekit-noscroll="">${escape_html(accthistory_load_more())}</a>`);
...
//# sourceMappingURL=_page.svelte.js-De2T1NhC.js.map
