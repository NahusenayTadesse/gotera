import { m as db, x as addons, j as eq, t as subscriptions, v as deliveries, k as and, A as alias, z as addresses, q as plans, f as ne, a as asc, i as inArray, w as subscriberAddons, p as subscribers } from '../../../chunks/db.js-C_Hkpclr.js';
import { f as fullDate, i as instantDate } from '../../../chunks/format.js-JAqogrJR.js';
import { i as isPastCutoff, c as cutoffDateFor } from '../../../chunks/delivery.js-C8Vz6MOt.js';
...
var load = async ({ locals }) => {
	...
	return {
		...
		addons: (await db.select().from(addons).where(eq(addons.isActive, true)).orderBy(addons.sortOrder)).map((a) => ({
			id: a.id,
			name: a.name,
...
//# sourceMappingURL=_page.server.ts.js-hd4-7PIN.js.map
