import { m as db, F as addresses, k as and, j as eq, p as subscribers } from '../../../../chunks/db.js-BXYNtFGm.js';
import { h as getLocale } from '../../../../chunks/runtime.js-CbeSlHLA.js';
import { l as lookupPostcode } from '../../../../chunks/geocode.js-hCa1RR8a.js';
import { a as auth, A as APIError } from '../../../../chunks/auth.js-ngFc_BkE.js';
...
import { o as object, y as email, s as string } from '../../../../chunks/access.js-BTJQW2Ke.js';
...
var actions = {
	...
	updateAddress: async ({ request, locals }) => {
		...
		const values = {
			...
			geocodedAt: geo ? /* @__PURE__ */ new Date() : null
		};
...
//# sourceMappingURL=_page.server.ts.js-C42vZnZm.js.map
