import { a0 as head, a9 as escape_html, T as derived, $ as attr, ae as store_get, a4 as ensure_array_like, af as unsubscribe_stores } from '../../../../chunks/server.js-CPNQ0GBv.js';
...
//#endregion
//#region src/lib/paraglide/messages/acctdetails_page_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Acctdetails_Page_TitleInputs */
var en_acctdetails_page_title = () => {
	return `Your details — GOTERA`;
};
var am_acctdetails_page_title = () => {
	return `የእርስዎ መረጃ — ጎቴራ`;
};
/**
* | output |
* | --- |
* | "Your details — GOTERA" |
*
* @param {Acctdetails_Page_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var acctdetails_page_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_acctdetails_page_title();
	return en_acctdetails_page_title();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		*/
		...
		head("qfqyj5", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(acctdetails_page_title())}</title>`);
			});
		});
		...
		if (editing.address) {
			...
			$$renderer.push(`<!--]--></div> <div class="af svelte-qfqyj5"><label class="af-label svelte-qfqyj5" for="postcode">${escape_html(acctdetails_postcode_label())}</label> <input id="postcode" class="edit-input svelte-qfqyj5" name="postcode" autocomplete="postal-code"${attr("list", postcode.listId)}${attr("value", store_get($$store_subs ??= {}, "$addressForm", addressForm).postcode)}/> <datalist${attr("id", postcode.listId)}><!--[-->`);
...
//# sourceMappingURL=_page.svelte.js-D7q_Ekjn.js.map
