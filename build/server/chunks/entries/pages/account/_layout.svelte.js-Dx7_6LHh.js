import { a0 as head, a9 as escape_html, aa as attr_class, ab as stringify$1, $ as attr, a4 as ensure_array_like, a1 as html, T as derived } from '../../../chunks/server.js-CPNQ0GBv.js';
import { h as getLocale } from '../../../chunks/runtime.js-CYqc9Mf9.js';
import { p as page } from '../../../chunks/state.js-DOkM2clz.js';
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></div></div></div> <div class="container svelte-1bm518h"><button type="button"${attr_class("menu-toggle svelte-1bm518h", void 0, { "open": menuOpen })}${attr("aria-expanded", menuOpen)} aria-controls="account-nav"><svg class="menu-toggle-icon svelte-1bm518h" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">`);
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<path d="M2 4.5h12M2 8h12M2 11.5h12"></path>`);
		$$renderer.push(`<!--]--></svg> <span class="menu-toggle-label svelte-1bm518h">${escape_html(activeLabel())}</span> <svg class="menu-toggle-chevron svelte-1bm518h" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M4 6l4 4 4-4"></path></svg></button> <div class="layout svelte-1bm518h"><aside id="account-nav"${attr_class("sidebar svelte-1bm518h", void 0, { "open": menuOpen })}><div class="sidebar-section svelte-1bm518h"><span class="sidebar-label svelte-1bm518h">${escape_html(account_sidebar_manage_label())}</span> <nav class="sidebar-nav svelte-1bm518h"><!--[-->`);
		const each_array = ensure_array_like(managementLinks());
		for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
			let link = each_array[$$index];
			$$renderer.push(`<a${attr("href", link.href)}${attr_class("sidebar-link svelte-1bm518h", void 0, { "active": currentPath() === link.href })}><svg class="sidebar-icon svelte-1bm518h" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">${html(link.iconPath)}</svg> ${escape_html(link.label)}</a>`);
		}
...
//# sourceMappingURL=_layout.svelte.js-Dx7_6LHh.js.map
