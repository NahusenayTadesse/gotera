import { a0 as head, a6 as escape_html, aa as attr_class, $ as attr, ab as stringify$1, a4 as ensure_array_like, a2 as attributes, a3 as clsx$1, a8 as bind_props, T as derived, a7 as spread_props, I as hasContext, J as getContext, F as setContext, E as run, ac as attr_style, a1 as html } from '../../chunks/server.js-qDPizQqb.js';
import { h as getLocale, l as locales, j as localizeHref, k as setLocale } from '../../chunks/runtime.js-CbeSlHLA.js';
import '../../chunks/routing.js-CJYUshuD.js';
import '../../chunks/internal2.js-DJ3WVXqP.js';
import '../../chunks/utils.js-BQt5v-8G.js';
import { M as Mode_watcher } from '../../chunks/dist.js-CopWy1Ce.js';
import { c as createSubscriber } from '../../chunks/scroll-lock.js-DUdP1Ngb.js';
import { S as SonnerState, t as toastState, c as cn } from '../../chunks/toast-state.svelte.js-CyESMgTY.js';
import { c as beforeNavigate, b as afterNavigate, i as invalidateAll } from '../../chunks/client.js-CWf6uOE8.js';
import { p as page } from '../../chunks/state.js-B8LH1nIO.js';
import { I as Icon } from '../../chunks/Icon.js-Dm6aSBgb.js';
import { h as home_meta_description } from '../../chunks/home_meta_description.js-COS4U_GP.js';
import { N as NotificationToggle, I as InstallAppRow } from '../../chunks/NotificationToggle.js-DSW1mLF-.js';
import { D as Dropdown_menu, a as Dropdown_menu_trigger, b as Dropdown_menu_content, c as Dropdown_menu_item } from '../../chunks/dropdown-menu.js-YJUTIf1N.js';
...
//#endregion
//#region src/lib/components/AppPrompts.svelte
function AppPrompts($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
	});
}
//#endregion
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		const organizationJsonLdScript = derived(() => `<script type="application/ld+json">${JSON.stringify({
		...
		head("12qhfyh", $$renderer, ($$renderer) => {
			...
			for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
				let locale = each_array[$$index];
				$$renderer.push(`<link rel="alternate"${attr("hreflang", locale)}${attr("href", page.url.origin + localizeHref(page.url.pathname, { locale }))}/>`);
			}
			$$renderer.push(`<!--]--> <link rel="alternate" hreflang="x-default"${attr("href", page.url.origin + localizeHref(page.url.pathname, { locale: "en" }))}/> <meta property="og:site_name" content="GOTERA"/> <meta property="og:type" content="website"/> <meta property="og:url"${attr("content", page.url.origin + page.url.pathname)}/> <meta property="og:image"${attr("content", page.url.origin + "/og-image.jpg")}/> <meta property="og:image:width" content="1200"/> <meta property="og:image:height" content="630"/> <meta name="twitter:card" content="summary_large_image"/> <meta name="twitter:image"${attr("content", page.url.origin + "/og-image.jpg")}/> ${html(organizationJsonLdScript())} <link rel="preconnect" href="https://fonts.googleapis.com"/> <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="anonymous"/> <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400;1,600&amp;family=Jost:wght@300;400;500;600&amp;display=swap" rel="stylesheet"/>`);
		});
		...
		if (!page.url.pathname.startsWith("/dashboard")) {
			$$renderer.push("<!--[0-->");
			AppPrompts($$renderer, { signedIn: !!data.user });
			...
			$$renderer.push(`<!--]--></div></div></nav> <nav${attr_class("nav--hero mobile-only svelte-12qhfyh", void 0, { "nav--scrolled": isScrolled })}${attr("aria-label", layout_hero_nav_aria())}><a href="/"${attr_class(`nav-logo ${nonWhiteBG() && true ? "text-white!" : ""}`, "svelte-12qhfyh")}${attr("aria-label", layout_hero_logo_aria())}>${escape_html(layout_brand_logo())}</a> <button${attr_class(`hamburger ${nonWhiteBG() && true ? "text-white!" : "text-primary!"}`, "svelte-12qhfyh", { "open": isDrawerOpen })}${attr("aria-label", layout_menu_open_aria())}${attr("aria-expanded", isDrawerOpen)}>`);
			Menu($$renderer, {});
			$$renderer.push(`<!----></button></nav> <div role="presentation"${attr_class("overlay svelte-12qhfyh", void 0, { "open": isDrawerOpen })}></div> <div${attr_class("drawer svelte-12qhfyh", void 0, { "open": isDrawerOpen })}><div class="drawer-head svelte-12qhfyh"><span class="drawer-logo svelte-12qhfyh">${escape_html(layout_brand_logo())}</span> <button class="drawer-close svelte-12qhfyh"${attr("aria-label", layout_menu_close_aria())}><svg viewBox="0 0 24 24" class="svelte-12qhfyh"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></div> <nav class="drawer-nav svelte-12qhfyh"${attr("aria-label", layout_drawer_nav_aria())}><a href="/subscribe" class="drawer-link svelte-12qhfyh">${escape_html(layout_drawer_subscribe())}</a> <a href="/about" class="drawer-link svelte-12qhfyh">${escape_html(layout_drawer_about())}</a> <a href="/faq" class="drawer-link svelte-12qhfyh">${escape_html(layout_drawer_faq())}</a> <a href="/account" class="drawer-link svelte-12qhfyh">${escape_html(data?.user ? layout_drawer_account() : layout_drawer_signin())}</a></nav> <div class="drawer-settings svelte-12qhfyh">`);
			if (data?.user) {
				$$renderer.push("<!--[0-->");
				NotificationToggle($$renderer);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--> `);
			InstallAppRow($$renderer);
			$$renderer.push(`<!----></div> <div class="drawer-bottom svelte-12qhfyh"><a href="/subscribe" class="drawer-cta svelte-12qhfyh">${escape_html(layout_drawer_cta())}</a></div></div> <main>`);
			children($$renderer);
			$$renderer.push(`<!----></main> <footer class="footer svelte-12qhfyh"><div class="container svelte-12qhfyh"><div class="footer-grid svelte-12qhfyh"><div><div class="footer-logo svelte-12qhfyh">${escape_html(layout_brand_logo())}</div> <p class="footer-tagline svelte-12qhfyh">${escape_html(layout_footer_tagline())}</p></div> <div><h2 class="svelte-12qhfyh">${escape_html(layout_footer_site_heading())}</h2> <div class="footer-links svelte-12qhfyh"><a href="/" class="svelte-12qhfyh">${escape_html(layout_footer_home())}</a> <a href="/subscribe" class="svelte-12qhfyh">${escape_html(layout_footer_subscribe())}</a> <a href="/about" class="svelte-12qhfyh">${escape_html(layout_footer_about())}</a> <a href="/account" class="svelte-12qhfyh">${escape_html(layout_footer_account())}</a></div></div> <div><h2 class="svelte-12qhfyh">${escape_html(layout_footer_legal_heading())}</h2> <div class="footer-links svelte-12qhfyh"><a href="/privacy" class="svelte-12qhfyh">${escape_html(layout_footer_privacy())}</a> <a href="/terms" class="svelte-12qhfyh">${escape_html(layout_footer_terms())}</a> <a href="/subscription-terms" class="svelte-12qhfyh">${escape_html(layout_footer_subscription_terms())}</a> <a href="/delivery" class="svelte-12qhfyh">${escape_html(layout_footer_delivery())}</a> <a href="/allergens" class="svelte-12qhfyh">${escape_html(layout_footer_allergens())}</a></div></div></div> <div class="footer-bottom svelte-12qhfyh"><span>${escape_html(layout_footer_copyright({ year: (/* @__PURE__ */ new Date()).getFullYear().toString() }))}</span> <span class="flex flex-row gap-2">${escape_html(layout_footer_bottom_tagline())} `);
...
//# sourceMappingURL=_layout.svelte.js-20YLH1rg.js.map
