import { a0 as head, a6 as escape_html, $ as attr, ae as store_get, af as unsubscribe_stores, a7 as spread_props } from '../../../chunks/server.js-qDPizQqb.js';
import { h as getLocale } from '../../../chunks/runtime.js-CbeSlHLA.js';
import { I as Icon } from '../../../chunks/Icon.js-Dm6aSBgb.js';
import { C as Circle_alert } from '../../../chunks/circle-alert.js-C4ujrG9B.js';
import { L as Loader_circle } from '../../../chunks/loader-circle.js-BHGq7rKE.js';
...
//#endregion
//#region src/lib/paraglide/messages/forgotpw_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Forgotpw_Meta_DescriptionInputs */
var en_forgotpw_meta_description = () => {
	return `Request a sign-in link to reset your GOTERA account password.`;
};
var am_forgotpw_meta_description = () => {
	return `የGOTERA መለያዎን የይለፍ ቃል ዳግም ለማስጀመር የመግቢያ አገናኝ ይጠይቁ።`;
};
/**
* | output |
* | --- |
* | "Request a sign-in link to reset your GOTERA account password." |
*
* @param {Forgotpw_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var forgotpw_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_forgotpw_meta_description();
	return en_forgotpw_meta_description();
});
//#endregion
...
//# sourceMappingURL=_page.svelte.js-DnvnPf48.js.map
