import { a0 as head, a6 as escape_html, $ as attr, T as derived, ae as store_get, af as unsubscribe_stores } from '../../../chunks/server.js-qDPizQqb.js';
...
import { p as page } from '../../../chunks/stores.js-85RLlu2u.js';
...
//#endregion
//#region src/lib/paraglide/messages/resetpw_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Resetpw_Meta_DescriptionInputs */
var en_resetpw_meta_description = () => {
	return `Set a new password for your GOTERA account.`;
};
var am_resetpw_meta_description = () => {
	return `ለGOTERA መለያዎ አዲስ የይለፍ ቃል ያዘጋጁ።`;
};
/**
* | output |
* | --- |
* | "Set a new password for your GOTERA account." |
*
* @param {Resetpw_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var resetpw_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_resetpw_meta_description();
	return en_resetpw_meta_description();
});
//#endregion
...
//# sourceMappingURL=_page.svelte.js-BJCbAA5b.js.map
