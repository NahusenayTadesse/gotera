...
//#endregion
//#region src/lib/paraglide/messages/login_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Login_Meta_DescriptionInputs */
var en_login_meta_description = () => {
	return `Sign in to your GOTERA account to manage your Ethiopian injera subscription, deliveries, and billing.`;
};
var am_login_meta_description = () => {
	return `የኢትዮጵያ እንጀራ ምዝገባዎን፣ መላኪያዎችን እና ክፍያዎን ለማስተዳደር ወደ GOTERA መለያዎ ይግቡ።`;
};
/**
* | output |
* | --- |
* | "Sign in to your GOTERA account to manage your Ethiopian injera subscription, deliveries, and billing." |
*
* @param {Login_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var login_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_login_meta_description();
	return en_login_meta_description();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		head("1x05zx6", $$renderer, ($$renderer) => {
			...
			$$renderer.push(`<meta name="description"${attr("content", login_meta_description())}/>`);
		});
...
//# sourceMappingURL=_page.svelte.js-D5RQVVln.js.map
