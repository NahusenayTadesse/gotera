import { a0 as head, a9 as escape_html, a4 as ensure_array_like, aa as attr_class, T as derived, $ as attr } from '../../../chunks/server.js-CPNQ0GBv.js';
...
//#endregion
//#region src/lib/paraglide/messages/faq_meta_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Faq_Meta_TitleInputs */
var en_faq_meta_title = () => {
	return `FAQ — GOTERA`;
};
var am_faq_meta_title = () => {
	return `ተደጋግሞ የሚነሱ ጥያቄዎች — GOTERA`;
};
/**
* | output |
* | --- |
* | "FAQ — GOTERA" |
*
* @param {Faq_Meta_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var faq_meta_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_faq_meta_title();
	return en_faq_meta_title();
});
//#endregion
//#region src/lib/paraglide/messages/faq_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Faq_Meta_DescriptionInputs */
var en_faq_meta_description = () => {
	return `Answers to common questions about GOTERA subscriptions, deliveries, billing, and your account — before and after you subscribe.`;
};
var am_faq_meta_description = () => {
	return `ስለ GOTERA ምዝገባዎች፣ መላኪያዎች፣ ክፍያ እና መለያዎ ተደጋግመው ለሚነሱ ጥያቄዎች መልሶች — ከመመዝገብዎ በፊት እና በኋላ።`;
};
/**
* | output |
* | --- |
* | "Answers to common questions about GOTERA subscriptions, deliveries, billing, and your account — before and after you subscribe." |
*
* @param {Faq_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var faq_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_faq_meta_description();
	return en_faq_meta_description();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let openAnswers = {};
		head("1bex8oj", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(faq_meta_title())}</title>`);
			});
			$$renderer.push(`<meta name="description"${attr("content", faq_meta_description())}/>`);
		});
...
//# sourceMappingURL=_page.svelte.js-n53ZLPQY.js.map
