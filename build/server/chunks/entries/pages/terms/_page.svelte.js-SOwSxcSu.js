import { a0 as head, a9 as escape_html, a4 as ensure_array_like, a1 as html, T as derived, $ as attr } from '../../../chunks/server.js-CPNQ0GBv.js';
import { h as getLocale } from '../../../chunks/runtime.js-CYqc9Mf9.js';
import '../../../chunks/shared.js-CgqsOrws.js';

//#region src/lib/paraglide/messages/terms_meta_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Terms_Meta_TitleInputs */
var en_terms_meta_title = () => {
	return `Terms of Service — GOTERA`;
};
var am_terms_meta_title = () => {
	return `የአገልግሎት ውሎች — GOTERA`;
};
/**
* | output |
* | --- |
* | "Terms of Service — GOTERA" |
*
* @param {Terms_Meta_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var terms_meta_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_terms_meta_title();
	return en_terms_meta_title();
});
//#endregion
//#region src/lib/paraglide/messages/terms_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Terms_Meta_DescriptionInputs */
var en_terms_meta_description = () => {
	return `Read the terms of service governing your use of the GOTERA website and your GOTERA subscription or purchase.`;
};
var am_terms_meta_description = () => {
	return `የGOTERA ድረ-ገጽ አጠቃቀምዎን እና የGOTERA ምዝገባዎን ወይም ግዢዎን የሚመሩ የአገልግሎት ውሎችን ያንብቡ።`;
};
/**
* | output |
* | --- |
* | "Read the terms of service governing your use of the GOTERA website and your GOTERA subscription or purchase." |
*
* @param {Terms_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var terms_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_terms_meta_description();
	return en_terms_meta_description();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		head("1e0rsuc", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(terms_meta_title())}</title>`);
			});
			$$renderer.push(`<meta name="description"${attr("content", terms_meta_description())}/>`);
		});
...
//# sourceMappingURL=_page.svelte.js-SOwSxcSu.js.map
