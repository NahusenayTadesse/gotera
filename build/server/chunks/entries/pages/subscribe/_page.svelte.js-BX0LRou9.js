import { a7 as bind_props, a0 as head, a9 as escape_html, $ as attr, ae as store_get, ac as attr_style, ab as stringify$1, a4 as ensure_array_like, aa as attr_class, T as derived, ag as store_mutate, af as unsubscribe_stores, a6 as spread_props } from '../../../chunks/server.js-CPNQ0GBv.js';
...
import { D as DialogComp } from '../../../chunks/DialogComp.js-fkV0zqVi.js';
import { B as Button } from '../../../chunks/button.js-DMlVoc1I.js';
import '../../../chunks/exports.js-BT-QlP_6.js';
import { b as superForm } from '../../../chunks/client2.js-CQ-oR-xa.js';
import { P as PostcodeLookup } from '../../../chunks/postcode.svelte.js-Dq27M4SR.js';
import '../../../chunks/auth-client.js-kIrFYup5.js';
...
//#endregion
//#region src/lib/paraglide/messages/subscribe_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subscribe_Meta_DescriptionInputs */
var en_subscribe_meta_description = () => {
	return `Choose a GOTERA injera subscription plan. Authentic Ethiopian teff injera delivered monthly to your door.`;
};
var am_subscribe_meta_description = () => {
	return `የGOTERA እንጀራ ምዝገባ እቅድ ይምረጡ። እውነተኛ የኢትዮጵያ ጤፍ እንጀራ በየወሩ ወደ በርዎ ይደርሳል።`;
};
/**
* | output |
* | --- |
* | "Choose a GOTERA injera subscription plan. Authentic Ethiopian teff injera delivered monthly to your door." |
*
* @param {Subscribe_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subscribe_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subscribe_meta_description();
	return en_subscribe_meta_description();
});
//#endregion
...
//#endregion
//#region src/lib/paraglide/messages/subscribe_choice_me_desc_mixed.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subscribe_Choice_Me_Desc_MixedInputs */
var en_subscribe_choice_me_desc_mixed = () => {
	return `Subscription or one-off order. Manage from your account.`;
};
var am_subscribe_choice_me_desc_mixed = () => {
	return `ምዝገባ ወይም የአንድ ጊዜ ትዕዛዝ። ከአካውንትዎ ያስተዳድሩ።`;
};
/**
* | output |
* | --- |
* | "Subscription or one-off order. Manage from your account." |
*
* @param {Subscribe_Choice_Me_Desc_MixedInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subscribe_choice_me_desc_mixed = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subscribe_choice_me_desc_mixed();
	return en_subscribe_choice_me_desc_mixed();
});
//#endregion
...
//#endregion
//#region src/lib/paraglide/messages/subscribe_kind_order.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subscribe_Kind_OrderInputs */
var en_subscribe_kind_order = () => {
	return `one-off order`;
};
var am_subscribe_kind_order = () => {
	return `የአንድ ጊዜ ትዕዛዝ`;
};
/**
* | output |
...
* | "one-off order" |
*
* @param {Subscribe_Kind_OrderInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subscribe_kind_order = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subscribe_kind_order();
	return en_subscribe_kind_order();
});
//#endregion
...
//#endregion
//#region src/lib/paraglide/messages/subscribe_tag_sub_or_one_off.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subscribe_Tag_Sub_Or_One_OffInputs */
var en_subscribe_tag_sub_or_one_off = () => {
	return `Subscription or one-off`;
};
var am_subscribe_tag_sub_or_one_off = () => {
	return `ምዝገባ ወይም የአንድ ጊዜ`;
};
/**
* | output |
* | --- |
...
*
* @param {Subscribe_Tag_Sub_Or_One_OffInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subscribe_tag_sub_or_one_off = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subscribe_tag_sub_or_one_off();
	return en_subscribe_tag_sub_or_one_off();
});
//#endregion
...
//#endregion
//#region src/lib/paraglide/messages/subscribe_who_me_desc_mixed.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Subscribe_Who_Me_Desc_MixedInputs */
var en_subscribe_who_me_desc_mixed = () => {
	return `Subscription or one-off · Manage from your account`;
};
var am_subscribe_who_me_desc_mixed = () => {
	return `ምዝገባ ወይም የአንድ ጊዜ · ከአካውንትዎ ያስተዳድሩ`;
};
/**
* | output |
* | --- |
* | "Subscription or one-off · Manage from your account" |
*
* @param {Subscribe_Who_Me_Desc_MixedInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var subscribe_who_me_desc_mixed = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_subscribe_who_me_desc_mixed();
	return en_subscribe_who_me_desc_mixed();
});
//#endregion
	...
	$$renderer.component(($$renderer) => {
		...
		*/
		const postcode = new PostcodeLookup((match) => {
			store_mutate($$store_subs ??= {}, "$form", form, store_get($$store_subs ??= {}, "$form", form).latitude = match?.latitude);
			store_mutate($$store_subs ??= {}, "$form", form, store_get($$store_subs ??= {}, "$form", form).longitude = match?.longitude);
		});
		...
		const addonQty = (id) => store_get($$store_subs ??= {}, "$form", form).addonQuantities[id] ?? 1;
		const activeAddons = derived(() => data?.addons.filter((a) => store_get($$store_subs ??= {}, "$form", form).addonIds.includes(a.id)) ?? []);
		const addonsTotal = derived(() => activeAddons().reduce((sum, a) => sum + a.pricePence / 100 * addonQty(a.id), 0));
		...
		*/
		const isOneOffPlan = (p) => !!p && (p.kind !== "subscription" || p.interval === "one_time");
		...
		*/
		const checkoutAction = derived(() => store_get($$store_subs ??= {}, "$form", form).recipient === "gift" ? "?/gift" : data?.user ? "?/subscribe" : "?/guestOrder");
		/**
		...
		*/
		const requiresAccount = derived(() => store_get($$store_subs ??= {}, "$form", form).recipient === "me" && !isOrder() && !data?.user);
		const mePrice = derived(() => recurringPlans().find((p) => p.id === "regular")?.price ?? recurringPlans()[recurringPlans().length - 1]?.price ?? 0);
		...
		function $$render_inner($$renderer) {
			head("s93h2j", $$renderer, ($$renderer) => {
				...
				$$renderer.push(`<meta name="description"${attr("content", subscribe_meta_description())}/> <link rel="preconnect" href="https://fonts.googleapis.com"/> <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="anonymous"/> <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400;1,600&amp;family=Jost:wght@300;400;500;600&amp;display=swap" rel="stylesheet"/>`);
			});
			...
			$$renderer.push(`<!--]--></div></div> <div class="sub-progress svelte-s93h2j"><div class="sub-progress__fill svelte-s93h2j"${attr_style(`width:${stringify$1(progress())}%`)}></div></div> <datalist${attr("id", postcode.listId)}><!--[-->`);
			const each_array = ensure_array_like(postcode.suggestions);
			for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
				let s = each_array[$$index];
				$$renderer.option({ value: s }, ($$renderer) => {});
			}
			$$renderer.push(`<!--]--></datalist> <form class="sub-card-wrap svelte-s93h2j" method="POST" id="start"><div${attr_class("sub-card svelte-s93h2j", void 0, { "animating": animating })}><div class="sub-card__head svelte-s93h2j">`);
			if (stepIdx > 0) {
				$$renderer.push("<!--[0-->");
			...
			if (step() === "extras") {
				...
				for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
					let addon = each_array_2[$$index_2];
					const selected = store_get($$store_subs ??= {}, "$form", form).addonIds.includes(addon.id);
					$$renderer.push(`<div class="extra-wrap svelte-s93h2j"><button type="button"${attr_class("extra-card svelte-s93h2j", void 0, { "added": selected })}><div class="extra-card__img svelte-s93h2j">${escape_html(addon.name)}</div> <div class="extra-card__body svelte-s93h2j"><span class="extra-card__name svelte-s93h2j">${escape_html(addon.name)}</span> `);
					if (addon.description) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<span class="extra-card__desc svelte-s93h2j">${escape_html(addon.description)}</span>`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--> <span class="extra-card__price svelte-s93h2j">+£${escape_html((addon.pricePence / 100).toFixed(2))}</span> <span class="extra-card__btn svelte-s93h2j">${escape_html(selected ? subscribe_addon_added() : subscribe_addon_add())}</span></div></button> `);
					if (selected) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<label class="extra-qty svelte-s93h2j"><span>Qty</span> <input type="number" min="1"${attr("max", MAX_ADDON_QTY)} step="1"${attr("value", addonQty(addon.id))} class="svelte-s93h2j"/> <span class="extra-qty__line svelte-s93h2j">£${escape_html((addon.pricePence / 100 * addonQty(addon.id)).toFixed(2))}</span></label>`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--></div>`);
				}
			...
			if (step() === "details") {
				...
				if (store_get($$store_subs ??= {}, "$form", form).recipient === "gift") {
					...
					$$renderer.push(`<!--]--></div> <div class="sub-field svelte-s93h2j"><label for="m-recipientName" class="svelte-s93h2j">${escape_html(subscribe_field_recipient_name_label())}</label> <input id="m-recipientName" type="text"${attr("value", store_get($$store_subs ??= {}, "$form", form).recipientName)} autocomplete="name" class="svelte-s93h2j"/> `);
					...
					$$renderer.push("<!--[-1-->");
					$$renderer.push(`<div class="sub-field svelte-s93h2j"><label for="phone" class="svelte-s93h2j">${escape_html(subscribe_field_phone_label())}</label> <input id="phone" type="tel" name="address"${attr("value", store_get($$store_subs ??= {}, "$form", form).phone)} autocomplete="tel" class="svelte-s93h2j"/></div> <div class="sub-field svelte-s93h2j"><label for="m-line1b" class="svelte-s93h2j">${escape_html(subscribe_field_line1_label())}</label> <input id="m-line1b" type="text"${attr("placeholder", subscribe_placeholder_street())}${attr("value", store_get($$store_subs ??= {}, "$form", form).line1)} autocomplete="address-line1" class="svelte-s93h2j"/> `);
					if (store_get($$store_subs ??= {}, "$errors", errors).line1) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<span class="sub-error svelte-s93h2j">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).line1)}</span>`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--></div> <div class="sub-field svelte-s93h2j"><label for="m-line2b" class="svelte-s93h2j">${escape_html(subscribe_field_line2_label())} <span class="opt svelte-s93h2j">${escape_html(subscribe_opt_optional_paren())}</span></label> <input id="m-line2b" type="text"${attr("placeholder", subscribe_placeholder_flat())}${attr("value", store_get($$store_subs ??= {}, "$form", form).line2)} autocomplete="address-line2" class="svelte-s93h2j"/></div> <div class="sub-field svelte-s93h2j"><div class="sub-field-row svelte-s93h2j"><div><label for="m-cityb" class="svelte-s93h2j">${escape_html(subscribe_field_city_label())}</label> <input id="m-cityb" type="text" disabled=""${attr("placeholder", subscribe_placeholder_london())}${attr("value", store_get($$store_subs ??= {}, "$form", form).city)} autocomplete="address-level2" class="svelte-s93h2j"/></div> <div><label for="m-postcodeb" class="svelte-s93h2j">${escape_html(subscribe_field_postcode_label())}</label> <input id="m-postcodeb" type="text"${attr("placeholder", subscribe_placeholder_postcode())}${attr("value", store_get($$store_subs ??= {}, "$form", form).postcode)} autocomplete="postal-code"${attr("list", postcode.listId)} class="svelte-s93h2j"/></div></div> <span class="sub-field-note svelte-s93h2j">${escape_html(subscribe_note_london_saturday())}</span> `);
					if (store_get($$store_subs ??= {}, "$errors", errors).postcode) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<span class="sub-error svelte-s93h2j">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).postcode)}</span>`);
					} else $$renderer.push("<!--[-1-->");
			...
			if (step() === "review") {
				...
				$$renderer.push(`<div class="pay-summary svelte-s93h2j"><div class="pay-row svelte-s93h2j"><span class="pay-row__label svelte-s93h2j">${escape_html(subscribe_label_quantity())}</span> <div class="qty-stepper svelte-s93h2j"><button type="button" class="qty-btn qty-btn--minus svelte-s93h2j"${attr("disabled", qty() <= 1, true)}${attr("aria-label", subscribe_aria_decrease_qty())}>−</button> <span class="qty-value svelte-s93h2j">${escape_html(qty())}</span> <button type="button" class="qty-btn qty-btn--plus svelte-s93h2j"${attr("aria-label", subscribe_aria_increase_qty())}>+</button></div></div> <div class="pay-row svelte-s93h2j"><span class="pay-row__label svelte-s93h2j">${escape_html(currentPlanDetails()?.name)}
								${escape_html(store_get($$store_subs ??= {}, "$form", form).recipient === "gift" ? subscribe_kind_gift() : currentIsOneOff() ? subscribe_kind_order() : subscribe_kind_subscription())} `);
				if (qty() > 1) {
					$$renderer.push("<!--[0-->");
				...
				const each_array_3 = ensure_array_like(activeAddons());
				for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
					let a = each_array_3[$$index_3];
					$$renderer.push(`<div class="pay-row svelte-s93h2j"><span class="pay-row__label svelte-s93h2j">${escape_html(a.name)}`);
					if (addonQty(a.id) > 1) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`× ${escape_html(addonQty(a.id))}`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--></span> <span class="pay-row__val svelte-s93h2j">+£${escape_html((a.pricePence / 100 * addonQty(a.id)).toFixed(2))}</span></div>`);
				}
			...
			if (step() === "review") {
				...
				if (requiresAccount()) {
					...
					$$renderer.push("<!--[-1-->");
					$$renderer.push(`<button type="submit" form="start"${attr("title", subscribe_title_continue())}${attr("formaction", checkoutAction())} class="sub-cta__btn svelte-s93h2j"${attr("disabled", store_get($$store_subs ??= {}, "$submitting", submitting), true)}>${escape_html(ctaLabel())}</button>`);
				}
				$$renderer.push(`<!--]-->`);
			} else {
				$$renderer.push("<!--[-1-->");
			...
			if (store_get($$store_subs ??= {}, "$form", form).recipient === "gift") {
				...
				const each_array_4 = ensure_array_like(giftPlans());
				...
				const each_array_5 = ensure_array_like(subscriptionPlans());
				for (let $$index_6 = 0, $$length = each_array_5.length; $$index_6 < $$length; $$index_6++) {
					let plan = each_array_5[$$index_6];
					...
					})}><h3 class="svelte-s93h2j">${escape_html(plan.name)}</h3> <p class="plan-sub svelte-s93h2j">${escape_html(plan.sub)}</p> <div class="price svelte-s93h2j">£${escape_html(plan.price.toFixed(plan.price % 1 === 0 ? 0 : 2))}</div> <div class="freq svelte-s93h2j">${escape_html(plan.freq)}</div> <ul class="svelte-s93h2j">`);
					if (plan.bullet && plan.bullet.trim() !== "") {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<!--[-->`);
						const each_array_6 = ensure_array_like(JSON.parse(plan.bullet));
			...
			$$renderer.push(` <div class="field-help svelte-s93h2j">${escape_html(subscribe_help_delivery_day())}</div></div> `);
			if (!currentIsOneOff()) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<div class="field-box svelte-s93h2j"><label class="field-label svelte-s93h2j" for="frequency">${escape_html(subscribe_field_frequency_label())}</label> `);
				$$renderer.select({
					id: "frequency",
					class: "select",
				...
				$$renderer.push(` <div class="field-help svelte-s93h2j">${escape_html(subscribe_help_frequency())}</div></div>`);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--></div></div></div> `);
			if (hasAddons()) {
				$$renderer.push("<!--[0-->");
				...
				for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
					...
					if (chosen) {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<label class="extra-qty svelte-s93h2j"><span>Qty</span> <input type="number" min="1"${attr("max", MAX_ADDON_QTY)} step="1"${attr("value", addonQty(item.id))} class="svelte-s93h2j"/> <span class="extra-qty__line svelte-s93h2j">£${escape_html((item.pricePence / 100 * addonQty(item.id)).toFixed(2))}</span></label>`);
					} else $$renderer.push("<!--[-1-->");
					$$renderer.push(`<!--]--></div>`);
				}
				$$renderer.push(`<!--]--></div> `);
			...
			if (store_get($$store_subs ??= {}, "$form", form).recipient === "gift") {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<div class="field full svelte-s93h2j"><div class="sub-field svelte-s93h2j"><label for="phone" class="svelte-s93h2j">${escape_html(subscribe_field_phone_label())}</label> <input id="phone" type="tel"${attr("value", store_get($$store_subs ??= {}, "$form", form).phone)} required="" autocomplete="tel" class="svelte-s93h2j"/></div> <div class="field full svelte-s93h2j"><label class="field-label svelte-s93h2j" for="buyerEmail">${escape_html(subscribe_field_email_label())}</label> <input id="buyerEmail" class="input svelte-s93h2j" type="email"${attr("placeholder", subscribe_placeholder_email())}${attr("value", store_get($$store_subs ??= {}, "$form", form).buyerEmail)} autocomplete="email"/> <div class="field-help svelte-s93h2j">${escape_html(subscribe_note_confirmation_receipt())}</div> `);
				if (store_get($$store_subs ??= {}, "$errors", errors).buyerEmail) {
					$$renderer.push("<!--[0-->");
					$$renderer.push(`<span class="form-error svelte-s93h2j">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).buyerEmail)}</span>`);
				} else $$renderer.push("<!--[-1-->");
				$$renderer.push(`<!--]--></div> <div class="field full svelte-s93h2j"><label class="field-label svelte-s93h2j" for="recipientName">${escape_html(subscribe_field_recipient_name_label())}</label> <input id="recipientName" class="input svelte-s93h2j" type="text"${attr("value", store_get($$store_subs ??= {}, "$form", form).recipientName)} autocomplete="name"/> `);
				if (store_get($$store_subs ??= {}, "$errors", errors).recipientName) {
					$$renderer.push("<!--[0-->");
					$$renderer.push(`<span class="form-error svelte-s93h2j">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).recipientName)}</span>`);
				} else $$renderer.push("<!--[-1-->");
				$$renderer.push(`<!--]--></div> <div class="field full svelte-s93h2j"><label class="field-label svelte-s93h2j" for="line1">${escape_html(subscribe_field_line1_label())}</label> <input id="line1" class="input svelte-s93h2j" type="text"${attr("value", store_get($$store_subs ??= {}, "$form", form).line1)} autocomplete="address-line1"/> `);
				if (store_get($$store_subs ??= {}, "$errors", errors).line1) {
					$$renderer.push("<!--[0-->");
					$$renderer.push(`<span class="form-error svelte-s93h2j">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).line1)}</span>`);
				} else $$renderer.push("<!--[-1-->");
				$$renderer.push(`<!--]--></div> <div class="field full svelte-s93h2j"><label class="field-label svelte-s93h2j" for="line2">${escape_html(subscribe_field_line2_label())} <span class="opt svelte-s93h2j">${escape_html(subscribe_opt_optional())}</span></label> <input id="line2" class="input svelte-s93h2j" type="text"${attr("value", store_get($$store_subs ??= {}, "$form", form).line2)} autocomplete="address-line2"/></div> <div class="field svelte-s93h2j"><label class="field-label svelte-s93h2j" for="city">${escape_html(subscribe_field_city_label())}</label> <input id="city" class="input svelte-s93h2j" disabled="" type="text"${attr("value", store_get($$store_subs ??= {}, "$form", form).city)} autocomplete="address-level2"/></div> <div class="field svelte-s93h2j"><label class="field-label svelte-s93h2j" for="postcode">${escape_html(subscribe_field_postcode_label())}</label> <input id="postcode" class="input svelte-s93h2j" type="text"${attr("value", store_get($$store_subs ??= {}, "$form", form).postcode)} autocomplete="postal-code"${attr("list", postcode.listId)}/> `);
				if (store_get($$store_subs ??= {}, "$errors", errors).postcode) {
					$$renderer.push("<!--[0-->");
			...
			$$renderer.push(`<!--]--></div></div> <div class="sum-row sum-row--qty svelte-s93h2j"><span class="sum-label svelte-s93h2j">${escape_html(subscribe_label_quantity())}</span> <div class="qty-stepper svelte-s93h2j"><button type="button" class="qty-btn qty-btn--minus svelte-s93h2j"${attr("disabled", qty() <= 1, true)}${attr("aria-label", subscribe_aria_decrease_qty())}>−</button> <span class="qty-value svelte-s93h2j">${escape_html(qty())}</span> <button type="button" class="qty-btn qty-btn--plus svelte-s93h2j"${attr("aria-label", subscribe_aria_increase_qty())}>+</button></div></div> <div class="sum-row svelte-s93h2j"><span class="sum-label svelte-s93h2j">${escape_html(subscribe_label_delivery())}</span> <div class="sum-val svelte-s93h2j">${escape_html(store_get($$store_subs ??= {}, "$form", form).deliveryDay)}${escape_html(currentIsOneOff() ? "" : ` · ${store_get($$store_subs ??= {}, "$form", form).frequency}`)}</div> <div class="sum-sub svelte-s93h2j">${escape_html(subscribe_note_london_only())}</div></div> `);
			if (activeAddons().length > 0) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<div class="sum-row svelte-s93h2j"><span class="sum-label svelte-s93h2j">${escape_html(subscribe_label_addons())}</span> <div class="sum-val svelte-s93h2j">${escape_html(activeAddons().map((a) => addonQty(a.id) > 1 ? `${a.name} × ${addonQty(a.id)}` : a.name).join(", "))}</div></div>`);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--> <div class="sum-row svelte-s93h2j"><span class="sum-label svelte-s93h2j">${escape_html(subscribe_label_total())}</span> <div class="price-line svelte-s93h2j"><span>${escape_html(currentPlanDetails()?.name)}
								${escape_html(subscribe_label_product_suffix())}`);
			if (qty() > 1) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`× ${escape_html(qty())}`);
			} else $$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--]--></span> <span>£${escape_html(planLineTotal().toFixed(2))}</span></div> <!--[-->`);
			const each_array_8 = ensure_array_like(activeAddons());
			for (let $$index_8 = 0, $$length = each_array_8.length; $$index_8 < $$length; $$index_8++) {
				let item = each_array_8[$$index_8];
				$$renderer.push(`<div class="price-line svelte-s93h2j"><span>${escape_html(item.name)}`);
				if (addonQty(item.id) > 1) {
					$$renderer.push("<!--[0-->");
					$$renderer.push(`× ${escape_html(addonQty(item.id))}`);
				} else $$renderer.push("<!--[-1-->");
				$$renderer.push(`<!--]--></span> <span>£${escape_html((item.pricePence / 100 * addonQty(item.id)).toFixed(2))}</span></div>`);
			}
			...
			if (requiresAccount()) {
				...
				Button($$renderer, {
					...
					children: ($$renderer) => {
						$$renderer.push(`<!---->${escape_html(store_get($$store_subs ??= {}, "$submitting", submitting) ? subscribe_cta_starting() : isOrder() ? subscribe_cta_order() : subscribe_cta_subscribe())}`);
					},
					$$slots: { default: true }
				});
			} else {
...
//# sourceMappingURL=_page.svelte.js-BX0LRou9.js.map
