import { a0 as head, a6 as escape_html, a4 as ensure_array_like, aa as attr_class, ab as stringify$1, a1 as html, T as derived, $ as attr } from '../../../chunks/server.js-qDPizQqb.js';
...
//#endregion
//#region src/lib/paraglide/messages/allergens_meta_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Allergens_Meta_TitleInputs */
var en_allergens_meta_title = () => {
	return `Allergen Information — GOTERA`;
};
var am_allergens_meta_title = () => {
	return `የአለርጂ መረጃ — GOTERA`;
};
/**
* | output |
* | --- |
* | "Allergen Information — GOTERA" |
*
* @param {Allergens_Meta_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var allergens_meta_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_allergens_meta_title();
	return en_allergens_meta_title();
});
//#endregion
//#region src/lib/paraglide/messages/allergens_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Allergens_Meta_DescriptionInputs */
var en_allergens_meta_description = () => {
	return `Full allergen and ingredient information for all GOTERA products, in line with UK Food Information to Consumers Regulation and Natasha's Law.`;
};
var am_allergens_meta_description = () => {
	return `ለሁሉም የGOTERA ምርቶች ሙሉ የአለርጂ እና የግብዓት መረጃ፣ ከዩኬ የምግብ መረጃ ለተጠቃሚዎች ደንብ ጋር በተጣጣመ መልኩ።`;
};
/**
* | output |
* | --- |
* | "Full allergen and ingredient information for all GOTERA products, in line with UK Food Information to Consumers Regulation and Natasha's Law." |
*
* @param {Allergens_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var allergens_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_allergens_meta_description();
	return en_allergens_meta_description();
});
//#endregion
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		head("1p9e3e4", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(allergens_meta_title())}</title>`);
			});
			$$renderer.push(`<meta name="description"${attr("content", allergens_meta_description())}/>`);
		});
...
//# sourceMappingURL=_page.svelte.js-9fZ7iSOX.js.map
