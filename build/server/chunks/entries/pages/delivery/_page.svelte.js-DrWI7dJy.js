import { a0 as head, a6 as escape_html, $ as attr } from '../../../chunks/server.js-qDPizQqb.js';
...
//#endregion
//#region src/lib/paraglide/messages/delivery_meta_title.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Delivery_Meta_TitleInputs */
var en_delivery_meta_title = () => {
	return `Delivery Information — GOTERA`;
};
var am_delivery_meta_title = () => {
	return `የመላኪያ መረጃ — GOTERA`;
};
/**
* | output |
* | --- |
* | "Delivery Information — GOTERA" |
*
* @param {Delivery_Meta_TitleInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var delivery_meta_title = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_delivery_meta_title();
	return en_delivery_meta_title();
});
//#endregion
//#region src/lib/paraglide/messages/delivery_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Delivery_Meta_DescriptionInputs */
var en_delivery_meta_description = () => {
	return `How and when GOTERA injera arrives at your door. Delivery areas, schedules, and everything you need to know about receiving your order.`;
};
var am_delivery_meta_description = () => {
	return `GOTERA እንጀራ እንዴትና መቼ ወደ በርዎ እንደሚደርስ። የመላኪያ አካባቢዎች፣ መርሃ ግብሮች እና ስለ ትዕዛዝዎ አቀባበል ማወቅ ያለብዎት ነገር ሁሉ።`;
};
/**
* | output |
* | --- |
* | "How and when GOTERA injera arrives at your door. Delivery areas, schedules, and everything you need to know about receiving your order." |
*
* @param {Delivery_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var delivery_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_delivery_meta_description();
	return en_delivery_meta_description();
});
//#endregion
//#region src/routes/delivery/+page.svelte
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		head("1n45kwt", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(delivery_meta_title())}</title>`);
			});
			$$renderer.push(`<meta name="description"${attr("content", delivery_meta_description())}/>`);
		});
...
//# sourceMappingURL=_page.svelte.js-DrWI7dJy.js.map
