...
//#endregion
//#region src/lib/paraglide/messages/signup_meta_description.js
/** @typedef {import('../runtime.js').LocalizedString} LocalizedString */
/** @typedef {{}} Signup_Meta_DescriptionInputs */
var en_signup_meta_description = () => {
	return `Create a GOTERA account to start a monthly Ethiopian injera subscription, delivered fresh to your door.`;
};
var am_signup_meta_description = () => {
	return `ወርሃዊ የኢትዮጵያ እንጀራ ምዝገባ ለመጀመር GOTERA መለያ ይፍጠሩ፣ ትኩስ ሆኖ ወደ በርዎ ይደርሳል።`;
};
/**
* | output |
* | --- |
* | "Create a GOTERA account to start a monthly Ethiopian injera subscription, delivered fresh to your door." |
*
* @param {Signup_Meta_DescriptionInputs} inputs
* @param {{ locale?: "en" | "am" }} options
* @returns {LocalizedString}
*/
var signup_meta_description = ((inputs = {}, options = {}) => {
	if ((options.locale ?? getLocale()) === "am") return am_signup_meta_description();
	return en_signup_meta_description();
});
//#endregion
...
//# sourceMappingURL=_page.svelte.js-CGvxKJXp.js.map
