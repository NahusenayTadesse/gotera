import { m as db, p as subscribers, j as eq } from '../../../chunks/db.js-BXYNtFGm.js';
...
import { o as object, c as boolean, s as string, y as email } from '../../../chunks/access.js-BTJQW2Ke.js';
...
var actions = { default: async ({ request }) => {
	...
	try {
		await db.update(subscribers).set({ marketingOptIn }).where(eq(subscribers.userId, userId));
	} catch (e) {
...
//# sourceMappingURL=_page.server.ts.js-DFn20Eqg.js.map
