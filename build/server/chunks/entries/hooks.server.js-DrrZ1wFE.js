import { A as get_request_store, m as merge_tracing, w as with_request_store, B as redirect, v as error } from '../chunks/utils.js-BQt5v-8G.js';
import { d as building } from '../chunks/internal.js-B6-4oVm4.js';
import { m as db, r as roles, u as user, j as eq } from '../chunks/db.js-C_Hkpclr.js';
import { c as cookieName, a as cookieMaxAge, g as getServerAsyncLocalStorage, i as isExcludedByRouteStrategy, s as serverAsyncLocalStorage, b as getStrategyForUrl, d as shouldRedirect, e as deLocalizeUrl, o as overwriteServerAsyncLocalStorage, f as getTextDirection } from '../chunks/runtime.js-CbeSlHLA.js';
import { a as auth, s as svelteKitHandler } from '../chunks/auth.js-DGyVL68z.js';
...
var handleDashboardGuard = async ({ event, resolve }) => {
	if (event.url.pathname.startsWith("/dashboard")) {
		if (!event.locals.user) return redirect(302, "/login");
		if (event.locals.role !== "Admin") return error(403, "Not Allowed");
	}
...
var handle = sequence(handleBetterAuth, handleDashboardGuard, handleParaglide);

export { handle };
//# sourceMappingURL=hooks.server.js-DrrZ1wFE.js.map
