...
return {
	...
	_: {
		client: {start:"_app/immutable/entry/start.C2OBLu01.js",app:"_app/immutable/entry/app.wegh9JJu.js",imports:["_app/immutable/entry/start.C2OBLu01.js","_app/immutable/chunks/CSl-2aJU.js","_app/immutable/chunks/Cxhu7noS.js","_app/immutable/entry/app.wegh9JJu.js","_app/immutable/chunks/Cxhu7noS.js","_app/immutable/chunks/DYl5dUZ5.js","_app/immutable/chunks/Bi76Sbi7.js","_app/immutable/chunks/xihTtKlq.js"],stylesheets:[],fonts:[],uses_env_dynamic_public:false},
		nodes: [
			__memo(() => import('./nodes/0.js-CWY7u4Wt.js')),
			__memo(() => import('./nodes/1.js-CYfuJ0yZ.js')),
			__memo(() => import('./nodes/2.js-BpC0ism7.js')),
			__memo(() => import('./nodes/3.js-Bw0exFEx.js')),
			__memo(() => import('./nodes/4.js-CZeM4TdL.js')),
			__memo(() => import('./nodes/5.js-C5KG9mBr.js')),
			__memo(() => import('./nodes/6.js-iSqLF4-m.js')),
			__memo(() => import('./nodes/7.js-DjX1oMMx.js')),
			__memo(() => import('./nodes/8.js-CJnspKwH.js')),
			__memo(() => import('./nodes/9.js-CSRif3Uc.js')),
			__memo(() => import('./nodes/10.js-CjawF7Lh.js')),
			__memo(() => import('./nodes/11.js-57Blm8QG.js')),
			__memo(() => import('./nodes/12.js-D4Zh_wXB.js')),
			__memo(() => import('./nodes/13.js-BQxFOYsu.js')),
			__memo(() => import('./nodes/14.js-wcLip9HH.js')),
			__memo(() => import('./nodes/15.js-CBXq8LPy.js')),
			__memo(() => import('./nodes/16.js-CMTt7ZTL.js')),
			__memo(() => import('./nodes/17.js-XM0DsHzi.js')),
			__memo(() => import('./nodes/18.js-CRaMmS8e.js')),
			__memo(() => import('./nodes/19.js-CMNWVzQD.js')),
			__memo(() => import('./nodes/20.js-CGtQjpc4.js')),
			__memo(() => import('./nodes/21.js-DX-V95lI.js')),
			__memo(() => import('./nodes/22.js-DFcRKtoN.js')),
			__memo(() => import('./nodes/23.js-CgdRmarP.js')),
			__memo(() => import('./nodes/24.js-DxGU8cG1.js')),
			__memo(() => import('./nodes/25.js-B8Eu2e8-.js')),
			__memo(() => import('./nodes/26.js-B7cMz_4L.js')),
			__memo(() => import('./nodes/27.js-DHt7GqQW.js')),
			__memo(() => import('./nodes/28.js-DilMIjAu.js')),
			__memo(() => import('./nodes/29.js-DKMWQlbD.js')),
			__memo(() => import('./nodes/30.js-B6Kwg_f1.js')),
			__memo(() => import('./nodes/31.js-BiHzb02s.js')),
			__memo(() => import('./nodes/32.js-Dj7GhCWo.js')),
			__memo(() => import('./nodes/33.js-DzGWv8f-.js')),
			__memo(() => import('./nodes/34.js-BwCCqp0T.js')),
			__memo(() => import('./nodes/35.js-BWabrDgl.js')),
			__memo(() => import('./nodes/36.js-BwQGN4rg.js')),
			__memo(() => import('./nodes/37.js-ExAFnMWe.js')),
			__memo(() => import('./nodes/38.js-C-W9afmj.js')),
			__memo(() => import('./nodes/39.js-BxtCVxRF.js')),
			__memo(() => import('./nodes/40.js-BbVKJRJR.js')),
			__memo(() => import('./nodes/41.js-D_xV8FE6.js')),
			__memo(() => import('./nodes/42.js-DHkLMh3F.js')),
			__memo(() => import('./nodes/43.js-CsRFARn0.js')),
			__memo(() => import('./nodes/44.js-CMdHqepG.js')),
			__memo(() => import('./nodes/45.js-DQqpKO3z.js')),
			__memo(() => import('./nodes/46.js-BgnK5HwF.js')),
			__memo(() => import('./nodes/47.js-z-JSEbP1.js')),
			__memo(() => import('./nodes/48.js-DUyXGKBz.js')),
			__memo(() => import('./nodes/49.js-D5PP37hH.js')),
			__memo(() => import('./nodes/50.js-CvUZfXmn.js')),
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cron/upcoming-deliveries/_server.ts.js-B6-KVlGf.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/stripe/webhook/_server.ts.js-D6e3nALX.js'))
			},
			{
...
//# sourceMappingURL=manifest.js-DJkOVaAN.js.map
