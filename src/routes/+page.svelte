...
<section class="hero hidden! lg:block!" aria-label="Hero">
  <div class="container hero-grid">
    <div>
      ...
      <h1 class="hero-title">Injera, every month.</h1>
      <div class="hero-meta">
      ...
      <p class="hero-copy">Real injera on a monthly subscription. Made in Ethiopia. Delivered to your door.</p>
  ...
  <div class="container gift-grid">
    ...
    <div class="gift-card">
      ...
      <div class="gift-card-body">
        <h3>Gift Box</h3>
        <p>Injera · Ethiopian Flatbread · 3 pieces</p>
      </div>
    </div>
  </div>
</section>
...
<style>
  ...
  .plan-featured .plan-desc, .plan-featured .freq, .plan-featured li {
  ...
  @media(max-width: 960px) {
    .hero-grid, .origin-grid, .gift-grid {
      grid-template-columns: 1fr;
    }
    .pillars-grid, .plans-grid, .proof-grid {
      grid-template-columns: 1fr 1fr;
    }
    .hero-card {
      order: -1;
